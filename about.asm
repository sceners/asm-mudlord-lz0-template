...
.data
String	db ' Linezer0',0Ah
		db 'proudly presents',0Ah
		db 0Ah
		db 'Home Cookin *Patch* 5.9',0Ah
		db 'Protection: Serial',0Ah
		db 0Ah
		db 'Cracked/coded by Team Lz0',0Ah
		db 'Graphics by Team Lz0',0Ah
		db 'msx: crocoprinter.....',0Ah
		db 0Ah
		db 'Our greetz fly out to:',0Ah
		db 0Ah
		db 'HERiTAGE',0Ah
		db 'RAZOR1911',0Ah
		db 'F4CG',0Ah
		db 'EMPHASiS',0Ah
		db 'ZENiTH',0Ah
		db 'and many other fine people',0Ah
		db 0Ah
		db 0Ah,0
